      ...
      questions: [
        {
          ...
          listeningFor:
            'What they underestimated, and whether the regret is technical or organisational. Strong answers name a decision, not a tool.',
        },
        {
          q: 'Walk me through a migration that took longer than planned.',
          thin: '“Scope crept and we had upstream dependencies.”',
          listeningFor:
            'The double-write period — how long they ran both systems and what they used to decide it was safe to cut over. Anyone who has done one talks about this unprompted.',
        },
        {
          q: 'Who disagreed with your architecture, and what happened?',
          thin: '“We aligned on a hybrid approach.”',
          listeningFor:
            'Whether they can state the other person’s case properly. If they cannot put it fairly, they never understood it, and the compromise was just fatigue.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'What happened afterwards — and whether they are willing to say they turned out to be wrong. A product person who has never been wrong in public has not been in enough rooms.',
        },
        {
          q: 'What did you kill, and how did you know it was time?',
          thin: '“We sunset a feature with low usage.”',
          listeningFor:
            'The number they looked at, the number they deliberately ignored, and who they had to convince. Killing things is a political act before it is an analytical one.',
        },
        {
          q: 'Describe something customers asked for that you did not build.',
          thin: '“We prioritised based on impact and effort.”',
          listeningFor:
            'What they actually said to the customer. The refusal is where product taste lives; the roadmap is just its output.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'What they were monitoring before it happened, and whether the threshold was set in advance or discovered through a complaint. The monitoring is the answer; the retrain is housekeeping.',
        },
        {
          q: 'Tell me about a data quality problem you found late.',
          thin: '“We had an upstream schema change that broke a pipeline.”',
          listeningFor:
            'How they found it, and what they changed so that class of problem surfaced sooner next time. Anyone can fix a break; few close the detection gap.',
        },
        {
          q: 'When did you decide a model was not worth shipping?',
          thin: '“The metrics were not strong enough.”',
          listeningFor:
            'The business threshold and who set it. People who have only worked offline quote model metrics; people who have shipped quote the number someone else cared about.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'What time they got the call, what they did in the first twenty minutes, and what they got wrong. This is the question certifications do not survive.',
        },
        {
          q: 'What did you have to leave unpatched, and how did you decide?',
          thin: '“We prioritised remediation by CVSS score.”',
          listeningFor:
            'The compensating control and the name of the person who accepted the residual risk. Security maturity is visible in how comfortably they discuss what they chose not to fix.',
        },
        {
          q: 'Tell me about a control you removed.',
          thin: '“We streamlined some legacy processes.”',
          listeningFor:
            'What it was protecting against and why that changed. People who have only ever added controls have never had to operate them at 3am.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'What they recommended before the escalation. Judgment lives in the position taken, not in the process followed to take it upward.',
        },
        {
          ...
          listeningFor:
            'Whether they can name one genuine ambiguity. Nobody who has actually worked in this space believes the guidance covers everything.',
        },
        {
          q: 'Tell me about a protocol deviation you handled.',
          thin: '“It was documented and reported in line with our SOP.”',
          listeningFor:
            'What the impact assessment concluded and who they told first. The sequence of those two things says a great deal about how they operate.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'What they did in the interval before the cause was known — stopped, flagged, or carried on. The interval is the answer; the root cause is just the ending.',
        },
        {
          ...
          listeningFor:
            'Whether they were comfortable with that close, and why. Most people who have run several are not entirely comfortable, and can tell you precisely why not.',
        },
        {
          q: 'When did you push back on a timeline?',
          thin: '“I raised it with the programme lead and we adjusted.”',
          listeningFor:
            'What they were prepared to lose. A pushback with nothing at stake is a note in a meeting, not a position.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'Who on the floor told them it was wrong, and whether they listened the first time they were told. Most plant improvements start as someone being ignored.',
        },
        {
          q: 'Tell me about a quality escape.',
          thin: '“We completed a root cause analysis and implemented corrective actions.”',
          listeningFor:
            'How far it travelled before it was caught and what containment cost. Everyone runs an RCA; not everyone has had to make the call to a customer.',
        },
        {
          q: 'Describe a shutdown you ran.',
          thin: '“We planned it thoroughly and executed to schedule.”',
          listeningFor:
            'What overran and what they cut to recover. Nothing of that size runs to plan, and the recovery decisions are the whole skill.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'The decision they made in month two that they would make differently. Overruns are almost always caused earlier than they are noticed.',
        },
        {
          q: 'What did you sign off that you were not entirely sure about?',
          thin: '“Everything went through the formal approval process.”',
          listeningFor:
            'Whether they can name one. Engineers who have carried real accountability all have an answer, and usually remember it clearly.',
        },
        {
          q: 'Describe a design change during construction.',
          thin: '“We issued a revision and updated the drawings.”',
          listeningFor:
            'What it cost, who ended up paying for it, and how that conversation went. The technical change is rarely the hard part.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'Whether they can name one decision that was genuinely theirs. GCC seniority is almost entirely a question about decision rights.',
        },
        {
          ...
          listeningFor:
            'What they did about it and whether anything actually changed. This is the clearest line between a delivery centre and a capability centre.',
        },
        {
          q: 'How did you handle a handover that kept failing?',
          thin: '“We improved documentation and increased overlap hours.”',
          listeningFor:
            'Whether they moved the work or moved the people. Adding calls is what you do when you cannot move ownership.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'Whether they can talk about the craft as well as the number. Taste that can only be defended with a metric is not taste, it is a report.',
        },
        {
          q: 'What did you launch that failed?',
          thin: '“We learned a lot from it and applied it later.”',
          listeningFor:
            'The specific assumption that was wrong and how quickly they knew. Vagueness here usually means they were not close enough to it.',
        },
        {
          q: 'Tell me about a time speed cost you quality.',
          thin: '“We shipped fast and iterated after.”',
          listeningFor:
            'What broke, who noticed first, and whether they would take the same trade again. The last part is the one that separates judgment from habit.',
        },
      ],
      roles: [
        {
      ...
      questions: [
        {
          ...
          listeningFor:
            'Something specific and dated. Ninety days is a quarter of the thesis, and a full quarter of listening is a decision in itself.',
        },
        {
          ...
          listeningFor:
            'What they would have needed to be certain, and why they did not wait for it. That gap is where speed either becomes a skill or becomes luck.',
        },
        {
          q: 'What did the sponsor want that you pushed back on?',
          thin: '“We aligned on priorities pretty quickly.”',
          listeningFor:
            'The thing they protected. Operators who have never disagreed with a board have not been in a hard enough room yet.',
        },
      ],
      roles: [
        {
